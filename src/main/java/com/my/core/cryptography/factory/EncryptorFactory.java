...
import com.my.core.cryptography.matrix.encryptor.SimpleMatrixTranspositionEncryptor;
...
public class EncryptorFactory {
    ...
    public static Encryptor getEncryptor(Algorithm algorithm) {
        switch (algorithm) {
            ...
            case SIMPLE_MATRIX_SHIFTING: return new SimpleMatrixTranspositionEncryptor();
